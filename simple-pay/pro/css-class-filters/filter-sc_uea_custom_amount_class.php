...
// Add or change the classes for fields using the 'sc-uea-custom-amount' class

// Add a class in addition to the default class.
function sc_uea_custom_amount_class_example( $default ) {
...
add_filter( 'sc_uea_custom_amount_class', 'sc_uea_custom_amount_class_example' );

// Don't use the default class and overwrite with multiple classes of your own
function sc_uea_custom_amount_class_example_2() {
    return 'my-css-class-1 my-class-2 my-class-3';
}
add_filter( 'sc_uea_custom_amount_class', 'sc_uea_custom_amount_class_example_2' );