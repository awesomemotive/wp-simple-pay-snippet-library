...
// Add or change the classes for fields using the 'sc-cf-number' class

// Add a class in addition to the default class.
function sc_cf_number_class_example( $default ) {
...
add_filter( 'sc_cf_number_class', 'sc_cf_number_class_example' );

// Don't use the default class and overwrite with multiple classes of your own
function sc_cf_number_class_example_2() {
    return 'my-css-class-1 my-class-2 my-class-3';
}
add_filter( 'sc_cf_number_class', 'sc_cf_number_class_example_2' );